<template>
    <div class="table-group">
        <div class="t-btn">
            <el-button @click="queryBeforeWeek">上一周
            </el-button>
            <el-button @click="queryNextWeek"
                       type="info">下一周
            </el-button>
        </div>
        <div class="t-btn" style="float: right;">
            <el-button @click="editUser = true">修改
            </el-button>
            <el-button @click="addUser = true"
                       type="info">添加
            </el-button>
        </div>
        <el-table
